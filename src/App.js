    ...
    return (
        <div className="app">
            <header className="app__header">
                <h1><img src="https://facebookbrand.com/wp-content/uploads/2018/09/Header-e1538151782912.png?w=50&h=50" className="app__logo" alt="React Messenger" /> Roy's Messenger</h1>
